...
// * Initialize chat model for generating synthetic furniture data

const llm = new Ollama({
  model: "mistral:latest",   // or "mistral", "codellama", etc. depending on what you pulled
...
const itemSchema = z.object({
  ...
  prices: z.object({                      // Nested object for pricing information
    ...
    sale_price: z.number().nullable(),               // Discounted price
  }),
